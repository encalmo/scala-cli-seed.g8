...
call(
  s"scala-cli --power test project.scala --suppress-deprecated-warnings --suppress-experimental-feature-warning --suppress-directives-in-multiple-files-warning --suppress-deprecated-feature-warning"
).foreach(
  println
)
