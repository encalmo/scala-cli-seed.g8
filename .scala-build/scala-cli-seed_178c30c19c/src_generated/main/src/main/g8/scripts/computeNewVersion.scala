...
final class computeNewVersion$_ {
def args = computeNewVersion_sc.args$
def scriptPath = """src/main/g8/scripts/computeNewVersion.sc"""
/*<script>*/
...
object computeNewVersion_sc {
  ...
  lazy val script = new computeNewVersion$_
...
export computeNewVersion_sc.script as `computeNewVersion`
