package src.main.g8.scripts


final class createReleaseBundle$_ {
def args = createReleaseBundle_sc.args$
def scriptPath = """src/main/g8/scripts/createReleaseBundle.sc"""
/*<script>*/
...
object createReleaseBundle_sc {
  ...
  lazy val script = new createReleaseBundle$_
...
export createReleaseBundle_sc.script as `createReleaseBundle`
